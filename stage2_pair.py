...
from data_provider.stage2_dm_pair import Stage2DM
...
def main(args):
    ...
    dm = Stage2DM(args.num_workers, args.batch_size, args.root, args.text_max_len, model.blip2qformer.pkt_dictionary, model.blip2qformer.mol_dictionary, args=args)
...
def get_args():
    ...
    parser = Stage2DM.add_model_speccific_args(parser)
