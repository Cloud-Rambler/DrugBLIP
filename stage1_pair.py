...
from data_provider.stage1_dm_pair import Stage1DM
...
def main(args):
    ...
    if args.init_checkpoint:
        model = Blip2Stage1.load_from_checkpoint(args.init_checkpoint, device=args.devices, strict=False,args=args)
    ...
    # data
    dm = Stage1DM(args.num_workers, args.batch_size, args.root, args.text_max_len, model.blip2qformer.pkt_dictionary, model.blip2qformer.mol_dictionary, args=args)
